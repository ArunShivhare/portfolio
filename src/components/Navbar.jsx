  ...
  return (
    <nav className="fixed top-0 w-full bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 z-50">
      <div className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
        ...
        {/* Right Side (Links + Toggle Together) */}
        <div className="flex items-center gap-8">
          ...
          <button
            ...
            className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white"
          >
